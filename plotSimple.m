...
highlight(hPlot,find(G.Nodes.Type=='fuse'),...
    'NodeColor',[1 0 1]);
hS(1) = scatter(x,y,4,[1 0 1],'filled','o','DisplayName','Fuse');

highlight(hPlot,find(G.Nodes.Type=='load'),...
    'NodeColor',[0.6350 0.0780 0.1840],'Marker','square','MarkerSize',8);
